 ...
 *  Used for deadlock detection to create waitForGraph. A graph is a collection of vertices, where the edges are stored as Adjacency list in a Vertex.
 * @version 0.1
 * Date: 2019-12-02
 *
...
class Graph {
    ...
    /**
     *  Detects if there is a cycle in the graph using DFS and maintaing
